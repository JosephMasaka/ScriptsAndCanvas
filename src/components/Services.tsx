...
const services = [
  ...
  },
  {
    ...
    description:
      "Intelligent automation powered by AI agents. We design and build agentic workflows, LLM integrations, and AI-driven tools that automate complex business processes.",
    tags: ["AI Agents", "LLM Integration", "Automation", "MCP"],
  },
];
